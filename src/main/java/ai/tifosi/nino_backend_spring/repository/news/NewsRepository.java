...
public interface NewsRepository extends JpaRepository<News, Long> {
    ...
    @Query("SELECT n FROM News n " +
            "WHERE (:search IS NULL OR n.title LIKE %:search% OR n.content LIKE %:search%) " +
            ...
            "AND (:keywordNames IS NULL OR EXISTS (SELECT k FROM n.keywords k WHERE k.name IN :keywordNames)) " +
